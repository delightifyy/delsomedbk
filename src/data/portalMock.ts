...
export const patientMock = {
  ...
  labRequests: [
    {
      id: "lab_001",
      date: "2026-04-28",
      test: "Lipid Panel & ECG",
      doctor: "Dr. Ibrahim Musa",
      lab: "DesolMed Diagnostics, Ikoyi",
      status: "completed" as const,
      result: "Total cholesterol slightly elevated; ECG normal.",
      attachments: ["Lipid_Panel.pdf", "ECG_Report.pdf"],
    },
    {
      id: "lab_002",
      date: "2026-03-12",
      test: "Full Blood Count & Vitamin D",
      doctor: "Dr. Chinedu Eze",
      lab: "DesolMed Diagnostics, Ikoyi",
      status: "completed" as const,
      result: "All values within normal range. Vitamin D borderline low.",
      attachments: ["FBC_Result.pdf"],
    },
    {
      id: "lab_003",
      date: "2026-05-15",
      test: "Blood Pressure Monitoring (24h)",
      doctor: "Dr. Chinedu Eze",
      lab: "Home Kit",
      status: "pending" as const,
      result: "",
  ...
  hmo: {
    ...
    memberId: "AXM-2025-019284",
    policyNumber: "POL-NG-77419-A",
    status: "active" as const,
    verifiedAt: "2026-04-02",
    expiresAt: "2027-01-31",
    annualLimitNGN: 2000000,
    usedNGN: 640000,
    coveredServices: [
  ...
  subscription: {
    ...
    consultationsUsed: 3,
    perks: [
      "Unlimited chat with GPs",
      "Priority video consultations",
      "Free e-prescription delivery",
  ...
  organization: {
    ...
    coverageTier: "Tier 2 — Premium",
    hrContact: "wellbeing@sterlingbank.ng",
    consultationsCovered: 24,
    consultationsUsed: 7,
    eligibleDependents: 3,
